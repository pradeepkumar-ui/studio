...
const mockAirlineAncillaries: any[] = [
  { id: '1', ancillaryCode: 'EXLG', name: 'Extra Legroom Seat', shortName: 'Legroom+', category: 'Seat', subcategory: 'Extra legroom seat', basePrice: 1500, currency: 'INR', status: 'Active', version: 1, airlineCode: '6E', owningBusinessUnit: 'Revenue', providerName: 'IndiGo' },
  { id: '2', ancillaryCode: 'WIFI', name: 'In-flight Wi-Fi', shortName: 'Wi-Fi', category: 'Wi-Fi / connectivity', subcategory: 'Wi-Fi pass', basePrice: 500, currency: 'INR', status: 'Active', version: 2, airlineCode: '6E', owningBusinessUnit: 'Inflight', providerName: 'IndiGo' },
  { id: '3', ancillaryCode: 'SEAT', name: 'Standard Seat', shortName: 'Seat', category: 'Seat', subcategory: 'Standard seat', basePrice: 800, currency: 'INR', status: 'Active', version: 1, airlineCode: '6E', owningBusinessUnit: 'Retailing', providerName: 'IndiGo' },
  { id: '4', ancillaryCode: 'BAGG', name: 'Baggage (10kg)', shortName: '10kg Bag', category: 'Baggage', subcategory: 'Extra baggage', basePrice: 1200, currency: 'INR', status: 'Active', version: 1, airlineCode: '6E', owningBusinessUnit: 'Operations', providerName: 'IndiGo' },
  { id: '5', ancillaryCode: 'MEAL', name: 'Premium Meal', shortName: 'Meal', category: 'Meal', subcategory: 'Premium dining', basePrice: 900, currency: 'INR', status: 'Onboarding', version: 1, airlineCode: '6E', owningBusinessUnit: 'Inflight', providerName: 'IndiGo' },
  { id: '6', ancillaryCode: 'LOUN', name: 'Lounge Access', shortName: 'Lounge', category: 'Lounge', subcategory: 'Airport lounge', basePrice: 2000, currency: 'INR', status: 'Active', version: 2, airlineCode: '6E', owningBusinessUnit: 'Loyalty', providerName: 'IndiGo' },
  { id: '7', ancillaryCode: 'PETS', name: 'Pet in Cabin', shortName: 'Pet', category: 'Special', subcategory: 'Pet transport', basePrice: 2500, currency: 'INR', status: 'Inactive', version: 1, airlineCode: '6E', owningBusinessUnit: 'Customer', providerName: 'IndiGo' }
];

const STATS = [
  { label: "Total Ancillaries", value: 42, color: "purple" as const, icon: <Globe /> },
  { label: "Active",           value: 38, color: "green"  as const, icon: <CheckCircle2 /> },
  { label: "Onboarding",       value: 3,  color: "amber"  as const, icon: <RefreshCw  /> },
  { label: "Retired",          value: 1,  color: "red"    as const, icon: <AlertCircle /> },
];
