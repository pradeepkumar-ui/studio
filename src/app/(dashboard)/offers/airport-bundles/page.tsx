...
const mockAirportOfferStrategies: AirportOfferStrategy[] = [
{ id: 'APT-OFR-001', name: 'Fast Track Plus', type: 'Single', ancillaryIds: ['HUB-AGG-001', 'HUB-AGG-004'], status: 'Active', validity: { from: '2026-05-01', to: '2026-10-15' }, cohortIds: ['BOM_BIZ_WAIT', 'Silver', 'Gold'], pricing: { type: 'PercentageDiscount', value: 15, currency: 'INR' }, dynamicPricing: { enabled: true, ruleType: 'CapacityBased', threshold: '< 5 Seats', adjustmentPercent: 20 }, guardRails: { minPrice: 40, maxPrice: 150 } },
{ id: 'APT-OFR-002', name: 'Lounge Plus', type: 'Single', ancillaryIds: ['HUB-AGG-003', 'HUB-AGG-007'], status: 'Active', validity: { from: '2026-05-01', to: '2026-10-31' }, cohortIds: ['DEL_FAM_TRANSIT'], pricing: { type: 'FixedPrice', value: 35, currency: 'INR' }, dynamicPricing: { enabled: false, ruleType: 'TimeBased', adjustmentPercent: 0 }, guardRails: { minPrice: 25, maxPrice: 80 } },
{ id: 'APT-OFR-003', name: 'Wi-Fi Plus', type: 'Single', ancillaryIds: ['HUB-AGG-002'], status: 'Active', validity: { from: '2026-05-01', to: '2026-06-31' }, cohortIds: [], pricing: { type: 'FixedPrice', value: 15, currency: 'INR' }, dynamicPricing: { enabled: true, ruleType: 'TimeBased', threshold: '07:00-10:00', adjustmentPercent: 10 }, guardRails: { minPrice: 10, maxPrice: 25 } },
{ id: 'APT-OFR-004', name: 'Food and Beverage Plus', type: 'Single', ancillaryIds: ['HUB-AGG-005'], status: 'Active', validity: { from: '2026-04-30', to: '2026-10-31' }, cohortIds: ['Platinum', 'VIP'], pricing: { type: 'FixedPrice', value: 120, currency: 'INR' }, dynamicPricing: { enabled: true, ruleType: 'CapacityBased', threshold: '< 2 Suites', adjustmentPercent: 25 }, guardRails: { minPrice: 100, maxPrice: 300 } },
{ id: 'APT-OFR-005', name: 'Lounge + Fast Track Combo', type: 'Bundle', ancillaryIds: ['HUB-AGG-006', 'HUB-AGG-005'], status: 'Active', validity: { from: '2026-05-01', to: '2026-10-31' }, cohortIds: ['DEL_ELITE_ARRIVE', 'CORP_PREMIUM'], pricing: { type: 'PercentageDiscount', value: 20, currency: 'INR' }, dynamicPricing: { enabled: false, ruleType: 'TimeBased', adjustmentPercent: 0 }, guardRails: { minPrice: 150, maxPrice: 500 } },
{ id: 'APT-OFR-006', name: 'Lounge + Wi-Fi Combo', type: 'Bundle', ancillaryIds: ['HUB-AGG-005', 'HUB-AGG-004'], status: 'Active', validity: { from: '2026-05-01', to: '2026-10-31' }, cohortIds: ['TRANSIT_LONG_HAUL'], pricing: { type: 'FixedPrice', value: 45, currency: 'INR' }, dynamicPricing: { enabled: true, ruleType: 'TimeBased', threshold: 'Morning Peak', adjustmentPercent: 15 }, guardRails: { minPrice: 40, maxPrice: 100 } },
{ id: 'APT-OFR-007', name: 'Fast Track + Parking Combo', type: 'Bundle', ancillaryIds: ['HUB-AGG-006'], status: 'Active', validity: { from: '2026-06-01', to: '2026-10-31' }, cohortIds: [], pricing: { type: 'FixedPrice', value: 95, currency: 'INR' }, dynamicPricing: { enabled: false, ruleType: 'CapacityBased', adjustmentPercent: 0 }, guardRails: { minPrice: 80, maxPrice: 150 } }
];
