...
{ id: 'APT-OFR-004', name: 'Parking Plus', type: 'Single', ancillaryIds: ['HUB-AGG-005'], status: 'Active', validity: { from: '2026-04-30', to: '2026-10-31' }, cohortIds: ['Platinum', 'VIP'], pricing: { type: 'FixedPrice', value: 120, currency: 'INR' }, dynamicPricing: { enabled: true, ruleType: 'CapacityBased', threshold: '< 2 Suites', adjustmentPercent: 25 }, guardRails: { minPrice: 100, maxPrice: 300 } },
