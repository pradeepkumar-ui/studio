...
const mockAirlineInventory: any[] = [
    ...
    { id: '5', ancillaryName: 'Extra Baggage', pssCode: 'XBAG', flightNumber: 'SQ308', totalCapacity: 100, available: 45, reserved: 8, status: 'Waitlist', aircraftType: 'B777', quotas: { Direct: 60, OTA: 30, GDS: 10 }, realTimePssSync: false },
