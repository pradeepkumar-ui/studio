...
const mockAirlineInventory: any[] = [
    { id: '1', ancillaryName: 'Extra Legroom', pssCode: 'EXLG', flightNumber: 'Global', totalCapacity: 12, available: 10, reserved: 2, status: 'Open', aircraftType: 'All', quotas: { Direct: 8, OTA: 2, GDS: 2 }, realTimePssSync: true , baseFare: "1500" },
    { id: '2', ancillaryName: 'Seat', pssCode: 'MEAL', flightNumber: 'Global', totalCapacity: 50, available: 40, reserved: 10, status: 'Open', aircraftType: 'All', quotas: { Direct: 40, OTA: 10, GDS: 0 }, realTimePssSync: false, baseFare: "800" },
    ...
    { id: '5', ancillaryName: 'Priority Baggage', pssCode: 'XBAG', flightNumber: 'Global', totalCapacity: 100, available: 92, reserved: 8, status: 'Open', aircraftType: 'All', quotas: { Direct: 60, OTA: 30, GDS: 10 }, realTimePssSync: false , baseFare: "1200"},
