...
const initialAirportServices: any[] = [
  ...
  { id: '7', ancillaryCode: 'PARK', name: 'Parking', shortName: 'Parking', category: 'Parking', subcategory: 'Airport parking', basePrice: 500, currency: 'INR', status: 'Active', version: 1, airportCode: 'BOM', providerName: 'Airport Parking', terminals: 'T2', journeyStage: 'Departure' },
