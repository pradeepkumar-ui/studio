...
const initialAirportServices: any[] = [
  { id: '1', ancillaryCode: 'FAST', name: 'Fast Track', shortName: 'Fast Track', category: 'Security', subcategory: 'Fast track pass', basePrice: 700, currency: 'INR', status: 'Active', version: 1, airportCode: 'BOM', providerName: 'Airport Services', terminals: 'T2', journeyStage: 'Departure' },
  { id: '2', ancillaryCode: 'FAST', name: 'Fast Track', shortName: 'Fast Track', category: 'Security', subcategory: 'Fast track pass', basePrice: 750, currency: 'INR', status: 'Active', version: 1, airportCode: 'DEL', providerName: 'Airport Services', terminals: 'T3', journeyStage: 'Departure' },
  { id: '3', ancillaryCode: 'LOUN', name: 'Lounge Access', shortName: 'Lounge', category: 'Lounge', subcategory: 'Lounge access', basePrice: 1800, currency: 'INR', status: 'Active', version: 1, airportCode: 'BOM', providerName: 'Airport Lounge', terminals: 'T2', journeyStage: 'Departure' },
  { id: '4', ancillaryCode: 'LOUN', name: 'Lounge Access', shortName: 'Lounge', category: 'Lounge', subcategory: 'Lounge access', basePrice: 2000, currency: 'INR', status: 'Active', version: 1, airportCode: 'DEL', providerName: 'Airport Lounge', terminals: 'T3', journeyStage: 'Departure' },
  { id: '5', ancillaryCode: 'WIFI', name: 'Wi-Fi', shortName: 'Wi-Fi', category: 'Connectivity', subcategory: 'Internet access', basePrice: 300, currency: 'INR', status: 'Active', version: 1, airportCode: 'BOM', providerName: 'Airport WiFi', terminals: 'T2', journeyStage: 'Both' },
  { id: '6', ancillaryCode: 'WIFI', name: 'Wi-Fi', shortName: 'Wi-Fi', category: 'Connectivity', subcategory: 'Internet access', basePrice: 300, currency: 'INR', status: 'Active', version: 1, airportCode: 'DEL', providerName: 'Airport WiFi', terminals: 'T3', journeyStage: 'Both' },
  { id: '7', ancillaryCode: 'FOOD', name: 'Food and Beverage', shortName: 'food and beverage', category: 'food and beverage', subcategory: 'food and beverage pass', basePrice: 500, currency: 'INR', status: 'Active', version: 1, airportCode: 'BOM', providerName: 'Airport food and beverage', terminals: 'T2', journeyStage: 'Departure' },
  { id: '8', ancillaryCode: 'FOOD', name: 'Food and Beverage', shortName: 'food and beverage', category: 'food and beverage', subcategory: 'food and beverage pass', basePrice: 600, currency: 'INR', status: 'Active', version: 1, airportCode: 'DEL', providerName: 'Airport food and beverage', terminals: 'T3', journeyStage: 'Departure' }
];
